...
public final class RBF {
    ...
    // initialize the RBF
    public RBF(double[] input, double[] targetOutput, int[] hiddenLayers, double upperBoundInitializationWeight, double upperBoundInitializationBias, double eta,
    ...
    public void forwardPropagation() {
        if (isHiddenLayerCountZero) {
            ...
            zMatrices[0] = MatrixOperations.gaussian(sMatrices[0], r, c);
            FMatrices[0] = MatrixOperations.transpose(MatrixOperations.derivativeGaussian(sMatrices[0], r, c));
            for (int i = 1; i < sMatrices.length; i++) {
                ...
                zMatrices[i] = MatrixOperations.gaussian(sMatrices[i], r, c);
                FMatrices[i] = MatrixOperations.transpose(MatrixOperations.derivativeGaussian(sMatrices[i], r, c));
            }
